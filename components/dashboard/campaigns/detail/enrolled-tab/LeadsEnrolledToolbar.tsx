    ...
    <div className="flex flex-col sm:flex-row sm:items-center gap-3">
      ...
      <div className="relative">
        <button
          ...
          className={cn(
            "flex items-center gap-2 px-4 py-2.5 rounded-xl border text-sm font-bold transition-all shadow-sm min-w-[175px] justify-between",
            isSortOpen
      ...
      {selectedIdsCount > 0 ? (
        <Button
          ...
          className="rounded-xl h-10 px-4 text-rose-600 border-rose-200 hover:bg-rose-50 shrink-0"
        >
          {isRemoving ? (
        ...
        <Button
          ...
          className="rounded-xl h-10 px-4 shrink-0 shadow-md shadow-primary/10"
        >
