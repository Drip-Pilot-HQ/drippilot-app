...
import { AssignFolderSubmenu } from "./AssignFolderSubmenu";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuTrigger,
      ...
      <div className="relative">
        ...
        {isOpen && (
          <>
            ...
            />
            <div className="absolute left-0 top-full mt-2 w-64 bg-white border border-slate-200 rounded-2xl shadow-2xl z-50 p-2 animate-in fade-in zoom-in-95 duration-200">
                        ...
                        {isOwnerOrAdmin && (
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-48">
                              <AssignFolderSubmenu folder={folder} />
                            </DropdownMenuContent>
                          </DropdownMenu>
                        )}
