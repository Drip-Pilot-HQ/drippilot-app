  ...
  return (
    <div className="relative">
      <button
        ...
        className={cn(
          "flex items-center gap-2 px-4 py-2.5 rounded-xl border text-sm font-bold transition-all shadow-sm whitespace-nowrap",
          value
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="absolute left-0 top-full mt-2 w-52 bg-white border border-slate-200 rounded-2xl shadow-xl z-50 p-2 animate-in fade-in zoom-in-95 duration-200">
            <button
              onClick={() => {
                onChange(undefined);
                setIsOpen(false);
              ...
              className={cn(
                "w-full flex items-center px-3 py-2 rounded-xl text-xs font-bold transition-all text-left",
                !value
